...
# Load the YOLO model
model = YOLO("/Users/sahithichimata/Downloads/PPE_detection_Kit-main/ppe.pt")

# Define class names
classNames = ['Hardhat', 'Mask', 'NO-Hardhat', 'NO-Mask', 'NO-Safety Vest', 'NO-Gloves', 'Person', 'Safety Cone',
