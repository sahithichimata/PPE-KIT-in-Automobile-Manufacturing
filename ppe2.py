...
video_path = "/Users/sahithichimata/Downloads/PPE_detection_Kit-main/Videos/ppe-2.mp4"  # Change to 0 for webcam
...
# Load YOLO model
model_path = "/Users/sahithichimata/Downloads/PPE_detection_Kit-main/best.pt"  # Path to the trained model
model = YOLO(model_path)

# Define class names
classNames = ['Hardhat', 'Mask', 'NO-Hardhat', 'NO-Mask', 'NO-Safety Vest', 'NO-Gloves', 'Gloves', 'Person', 
...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if class_name in ['NO-Hardhat', 'NO-Mask', 'NO-Safety Vest', 'NO-Gloves']:
